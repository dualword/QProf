...
public:
    ...
    inline AxisType type() const {
        return m_type;
    }


    void setRanges(double min, double max);
    inline double rangeMininum() const {
        return m_min;
    }
    inline double rangeMaximum() const {
        return m_max;
    }

    void setTicks(double minor, double major);
    inline double minorTicks() const {
        return m_minor;
    }
    inline double majorTicks() const {
        return m_major;
    }
    ...
    inline const QPen& minorTicksPen() const {
        return m_minorPen;
    }

    void setMajorTicksPen(const QPen &pen);
    inline const QPen& majorTicksPen() const {
        return m_majorPen;
    }

    void setMinorGridPen(const QPen &pen);
    inline const QPen& minorGridPen() const {
        return m_minorGridPen;
    }

    void setMajorGridPen(const QPen &pen);
    inline const QPen& majorGridPen() const {
        return m_majorGridPen;
    }
