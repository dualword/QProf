 ...
 *                                                                         *
 ***************************************************************************/
#include "./includes/parseprofile_sleepy.h"
...
CParseProfile_sleepy::CParseProfile_sleepy (QTextStream& t, QVector<CProfileInfo>& profile)
{
    /*
...
bool CParseProfile_sleepy::valid() const
{
    return mValid;
}
