 ...
 *                                                                         *
 ***************************************************************************/
#include "./includes/parseprofile_perf.h"
...
CParseProfile_perf::CParseProfile_perf (QTextStream& t, QVector<CProfileInfo>& profile)
{
    /*
...
bool CParseProfile_perf::valid() const
{
    return mValid;
}
